...
from LLM.SAPSO.PSO.ObjectiveFunctions.ObjectiveFunction import ObjectiveFunction
...
class NorwegianFunction(ObjectiveFunction):
    ...
    # Add to PSO-ToyBox/LLM/PSO/ObjectiveFunctions/Training/Norweigan.py (Note typo in filename)
